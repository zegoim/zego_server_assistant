...
{
    ZegoToken04Result ZegoServerAssistant::GenerateToken04(uint32_t appID, const std::string& userID, const std::string& secret, int64_t effectiveTimeInSeconds, std::string payloadJson)
    {
        ...
        std::string             result
          = serverAssistantImpl.GenerateToken04(appID, userID, secret, effectiveTimeInSeconds, payloadJson);
